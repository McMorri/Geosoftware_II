...
function newPub() {
    bootbox.dialog({
        ...
        message: '<div class="input-group"><span class="input-group-addon" id="sizing-addon2">Publicationname</span><input id="pubname" type="text" class="form-control" placeholder="..." aria-describedby="sizing-addon2"></div>'
                    ...
                    //+ '<br> <div class="input-group"><span class="input-group-addon" id="sizing-addon2">Upload</span><input type='file' accept='tex' class="btn btn-default" onchange='Readdata(event)' aria-describedby="sizing-addon2"></div>',
